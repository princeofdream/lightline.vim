...
let s:git_bg = [ '#d7d7af', 230 ]
let s:git_fg = [ '#262626', 238 ]
let s:file_fg= [ '#f0f0f0', 254 ]
let s:file_bg= [ '#2a2a2a', 238 ]
" let s:rd_fg  = [ '#3a3a3a', 237 ]
" let s:rd_bg  = [ '#d7afff', 183 ]
let s:rd_fg  = s:fg
let s:rd_bg  = [ '#282c34', 235 ]
...
if lightline#colorscheme#background() ==# 'light'
  ...
  let s:p.normal.left     = [ [ s:bg, s:green, 'bold' ], [ s:git_fg, s:git_bg ] ]
  ...
  let s:p.normal.left     = [ [ s:bg, s:green, 'bold' ], [ s:git_fg, s:git_bg ], [s:rd_fg, s:rd_bg] ]
  let s:p.normal.middle   = [ [ s:fg, s:gray2 ] ]
  " let s:p.inactive.left   = [ [ s:gray1,  s:bg ], [ s:gray1, s:bg ] ]
  let s:p.inactive.left   = [ [ s:gray1,  s:bg ], [ s:git_fg, s:git_bg ] , [s:rd_fg, s:rd_bg] ]
  ...
  let s:p.insert.left     = [ [ s:bg, s:blue, 'bold' ], [ s:git_fg, s:git_bg ], [s:rd_fg, s:rd_bg] ]
  let s:p.replace.left    = [ [ s:bg, s:red1, 'bold' ], [ s:git_fg, s:git_bg ], [s:rd_fg, s:rd_bg] ]
  let s:p.visual.left     = [ [ s:bg, s:purple, 'bold' ], [ s:git_fg, s:git_bg ], [s:rd_fg, s:rd_bg] ]
endif
